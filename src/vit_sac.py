...
class CycDMSacAgent(object):
    ...
    def __init__(
        ...
        # TODO: tie weights of cnn+transformers
        # utils.soft_update_params(
        #     self.critic.encoder.vit, 
        #     self.actor.encoder.vit, 
        #     tau=1
        #     )
        # self.actor.encoder.vit.load_state_dict(self.critic.encoder.vit.state_dict())
        ...
        # params = list(self.critic.Q1.parameters()) + list(self.critic.Q2.parameters())
        # self.critic_Q_optimizer = torch.optim.Adam(params,
        #                                          lr=critic_lr,
        #                                          betas=(critic_beta, 0.999))
        # self.critic_encoder_optimizer = torch.optim.AdamW(self.critic.encoder.parameters(),
        #                                          lr=critic_lr,
        #                                          betas=(critic_beta, 0.999))
        ...
        if self.encoder_type == 'pixel':
            ...
            self.cycdm_optimizer = torch.optim.Adam(self.CycDM.parameters(),
    ...
    def update_critic(self, obs, action, reward, next_obs, not_done, L, step):
        ...
        current_Q1, current_Q2 = self.critic(
            obs, action, detach_encoder=self.detach_encoder)    # self.detach_encoder = False
    ...
    def update_cycdm(self, cycdm_kwargs, L, step):
        ...
        # for name, param in self.CycDM.named_parameters():
        #     print(name)
    ...
    def update(self, replay_buffer, L, step):
        ...
        # for named_param1, named_param2 in zip(self.actor.encoder.named_parameters(), self.critic.encoder.named_parameters()):
        #     name1, param1 = named_param1
        #     name2, param2 = named_param2
        #     print((param1.data.mean() == param2.data.mean()).float())
        #     if not param1.data.mean() == param2.data.mean():
        #         print(name1, name2)
        # print("--------------")
