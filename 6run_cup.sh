...
srun python ./train.py --config-path ./configs --config-name ball_in_cup_catch jumps=15 seed=1 num_env_steps=105000 wandb=true agent=mtm_sac 
srun python ./train.py --config-path ./configs --config-name ball_in_cup_catch jumps=15 seed=2 num_env_steps=105000 wandb=true agent=mtm_sac 
srun python ./train.py --config-path ./configs --config-name ball_in_cup_catch jumps=15 seed=3 num_env_steps=105000 wandb=true agent=mtm_sac 
