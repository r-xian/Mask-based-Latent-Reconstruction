...
srun python ./train.py --config-path ./configs --config-name finger_spin jumps=15 seed=1 num_env_steps=105000 wandb=true agent=mtm_sac 
...
srun python ./train.py --config-path ./configs --config-name finger_spin jumps=15 seed=4 num_env_steps=105000 wandb=true agent=mtm_sac 
srun python ./train.py --config-path ./configs --config-name finger_spin jumps=15 seed=5 num_env_steps=105000 wandb=true agent=mtm_sac 
